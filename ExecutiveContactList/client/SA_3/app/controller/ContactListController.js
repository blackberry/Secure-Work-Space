/*
 * File: app/controller/ContactListController.js
 *
...
Ext.define('MyApp.controller.ContactListController', {
    ...
    config: {
        control: {
            "#ContactList": {
                loadAndShowDetails: 'loadAndShowDetails'
            }
        }
    },

    loadAndShowDetails: function(contactlist, contactdetailcontainer, contactdetailsinfocontainer, data) {
